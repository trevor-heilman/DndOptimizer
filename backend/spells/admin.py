...
class SpellAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "name", "level", "school", "source", "is_custom")}),
        ("Casting Properties", {"fields": ("casting_time", "range", "duration", "concentration", "ritual")}),
        (
            "Combat Properties",
            {
                "fields": (
        ...
        ("Description", {"fields": ("description", "higher_level")}),
