...
class TestDamageComponentModel:
    ...
    def test_create_damage_component(self):
        ...
        damage = DamageComponent.objects.create(
            spell=spell, dice_count=8, die_size=6, damage_type="fire", timing="on_fail", is_verified=True
        )
    ...
    def test_damage_component_with_modifier(self):
        ...
        damage = DamageComponent.objects.create(
            spell=spell, dice_count=1, die_size=10, flat_modifier=5, damage_type="force", timing="on_hit"
        )
    ...
    def test_multiple_damage_components(self):
        ...
        DamageComponent.objects.create(spell=spell, dice_count=1, die_size=10, damage_type="piercing", timing="on_hit")

        # Secondary damage on fail
        DamageComponent.objects.create(spell=spell, dice_count=2, die_size=6, damage_type="cold", timing="on_fail")
    ...
    def test_condition_label_stored_and_retrieved(self):
        ...
        dc = DamageComponent.objects.create(
            ...
            damage_type="psychic",
            timing="on_hit",
            condition_label="target is frightened",
        )
...
class TestSpellParsingMetadata:
    ...
    def test_create_parsing_metadata(self):
        ...
        metadata = SpellParsingMetadata.objects.create(
            spell=spell, parsing_confidence=0.85, requires_review=False, parsing_notes={"test": "data"}
        )
    ...
    def test_review_workflow(self):
        ...
        user = User.objects.create_user(username="reviewer", email="reviewer@example.com", password="pass123")
        ...
        metadata = SpellParsingMetadata.objects.create(spell=spell, parsing_confidence=0.5, requires_review=True)
...
class TestSpellbookModel:
    ...
    def test_create_spellbook(self):
        ...
        user = User.objects.create_user(username="player", email="player@example.com", password="pass123")

        spellbook = Spellbook.objects.create(
            owner=user, name="My Wizard Spells", description="Spells for my wizard character"
        )
    ...
    def test_add_spell_to_spellbook(self):
        ...
        spellbook = Spellbook.objects.create(owner=user, name="My Spells")
        ...
        PreparedSpell.objects.create(spellbook=spellbook, spell=spell1, prepared=True, notes="My favorite damage spell")
    ...
    def test_spellbook_str(self):
        ...
        spellbook = Spellbook.objects.create(owner=user, name="Wizard Spells")
...
class TestAnalysisModels:
    ...
    def test_create_spell_comparison(self):
        ...
        context = AnalysisContext.objects.create(target_ac=15, spell_save_dc=13)

        comparison = SpellComparison.objects.create(
            spell_a=spell1,
            spell_b=spell2,
            context=context,
            results={"spell_a_avg_damage": 28.0, "spell_b_avg_damage": 28.0, "winner": "tie"},
        )
...
class TestCharacterMaxPreparedSpells:
    ...
    @pytest.fixture
    def user(self, db):
        return User.objects.create_user(username="chartest", email="chartest@example.com", password="pass")
    ...
    def test_wizard_2024_mod_ignored(self, user):
        ...
        char_high = self._char(
            user, character_class="wizard", ruleset="2024", character_level=5, spellcasting_ability_modifier=5
        )
        char_low = self._char(
            user, character_class="wizard", ruleset="2024", character_level=5, spellcasting_ability_modifier=0
        )
    ...
    def test_wizard_2014_mod_plus_level(self, user):
        ...
        char = self._char(
            user, character_class="wizard", ruleset="2014", character_level=5, spellcasting_ability_modifier=3
        )
    ...
    def test_wizard_2014_clamped_to_one(self, user):
        ...
        char = self._char(
            user, character_class="wizard", ruleset="2014", character_level=1, spellcasting_ability_modifier=-3
        )
    ...
    def test_prepared_spells_bonus_stacks(self, user):
        ...
        char = self._char(
            ...
            ruleset="2014",
            character_level=4,
            spellcasting_ability_modifier=2,
    ...
    def test_prepared_spells_bonus_on_2024_wizard(self, user):
        ...
        char = self._char(user, character_class="wizard", ruleset="2024", character_level=5, prepared_spells_bonus=2)
    ...
    def test_paladin_2014_uses_half_level(self, user):
        ...
        char = self._char(
            user, character_class="paladin", ruleset="2014", character_level=6, spellcasting_ability_modifier=4
        )
    ...
    def test_paladin_2024_uses_full_level(self, user):
        ...
        char = self._char(
            user, character_class="paladin", ruleset="2024", character_level=6, spellcasting_ability_modifier=4
        )
    ...
    def test_artificer_half_level(self, user):
        ...
        char = self._char(
            user, character_class="artificer", ruleset="2014", character_level=8, spellcasting_ability_modifier=3
        )
    ...
    def test_bard_2014_returns_none(self, user):
        ...
        char = self._char(
            user, character_class="bard", ruleset="2014", character_level=5, spellcasting_ability_modifier=3
        )
    ...
    def test_bard_2024_uses_mod_plus_level(self, user):
        ...
        char = self._char(
            user, character_class="bard", ruleset="2024", character_level=5, spellcasting_ability_modifier=3
        )
        assert char.max_prepared_spells == 8  # 3 + 5
    ...
    def test_ranger_2024_half_level(self, user):
        ...
        char = self._char(
            user, character_class="ranger", ruleset="2024", character_level=6, spellcasting_ability_modifier=2
        )
