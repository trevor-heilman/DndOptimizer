...
class TestSpellAPI:
    ...
    def test_update_spell(self, authenticated_client, test_spell):
        ...
        response = authenticated_client.put(f"/api/spells/spells/{test_spell.id}/", data, format="json")
...
class TestSpellbookAPI:
    ...
    def test_create_spellbook(self, authenticated_client):
        ...
        data = {"name": "My Wizard Spells", "description": "Spells for my wizard character"}
    ...
    def test_list_spellbooks(self, authenticated_client, test_user):
        ...
        Spellbook.objects.create(owner=test_user, name="Spellbook 1")
        Spellbook.objects.create(owner=test_user, name="Spellbook 2")
    ...
    def test_add_spell_to_spellbook(self, authenticated_client, test_user, test_spell):
        ...
        spellbook = Spellbook.objects.create(owner=test_user, name="My Spells")

        data = {"spell_id": str(test_spell.id), "prepared": True, "notes": "Great damage spell"}

        response = authenticated_client.post(f"/api/spellbooks/{spellbook.id}/add_spell/", data)
    ...
    def test_remove_spell_from_spellbook(self, authenticated_client, test_user, test_spell):
        ...
        response = authenticated_client.delete(f"/api/spellbooks/{spellbook.id}/remove_spell/?spell_id={test_spell.id}")
    ...
    def test_duplicate_spellbook(self, authenticated_client, test_user, test_spell):
        ...
        spellbook = Spellbook.objects.create(owner=test_user, name="Original Spellbook")
        spellbook.spells.add(test_spell)

        response = authenticated_client.post(f"/api/spellbooks/{spellbook.id}/duplicate/", {})
...
class TestAnalysisAPI:
    ...
    def test_compare_spells(self, authenticated_client, test_spell):
        ...
        DamageComponent.objects.create(
            spell=spell2, dice_count=8, die_size=6, damage_type="lightning", timing="on_fail"
        )
    ...
    def test_breakeven_analysis(self, authenticated_client, test_spell):
        ...
        DamageComponent.objects.create(spell=spell_b, dice_count=2, die_size=6, damage_type="fire", timing="on_hit")
...
class TestCaching:
    ...
    def test_analysis_result_cached_on_second_request(self, authenticated_client, test_spell):
        ...
        assert any(
            "analysis:analyze:" in k for k in set_calls
    ...
    def test_efficiency_result_cached(self, authenticated_client, test_spell):
        ...
        assert r1.status_code == status.HTTP_200_OK
        assert any(
            "analysis:efficiency:" in k for k in set_calls
...
class TestPermissions:
    ...
    def test_cannot_delete_others_spellbook(self, test_user, test_spell):
        ...
        other_spellbook = Spellbook.objects.create(owner=other_user, name="Other Spellbook")
